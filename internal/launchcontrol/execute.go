...
func requestFence(req Request) flowstore.PhaseLaunchFence {
	return flowstore.PhaseLaunchFence{
		LaunchID:     req.LaunchID,
		OwnerPhaseID: artifacts.NormalizePhaseID(req.OwnerPhaseID),
	}
}
