...
func (m Model) createFlowAndLaunchPlanForRepoWithIdentity(repoPath, title, instructions, baseRef string, headless bool, flowID, token string) tea.Cmd {
	...
	return func() tea.Msg {
		...
		return flowPlanLaunchMessage(result.LaunchContext, flowLaunchSourceCreatePhase, flowID, token)
	}
}
...
func flowPlanLaunchMessage(ctx actions.AgentLaunchContext, source flowLaunchSource, flowID, token string) tea.Msg {
