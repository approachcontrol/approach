...
- [x] P3 - Agent-session capture and browsing: ingest Claude/Codex hook payloads, associate sessions with repos/worktrees/branches, page normalized transcripts in mode 6, resume selected sessions, and copy raw provider session IDs.
