...
previous view. Moving focus to the left repo pane temporarily filters the visible
...
`--output-format stream-json --include-partial-messages` and wtui translates
