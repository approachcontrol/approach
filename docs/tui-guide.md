...
configured-versus-error classification, and pager remain deferred. Keys
`6`–`9` remain unbound; frozen `default_view` meanings `1`–`9` are unchanged,
and `10`–`14` start directly in Ready, Blocked, Open, In-Progress, or Closed.
