...
func renderFlowFooterShortcuts(sp statusBarParams, sections []shortcutSection) string {
	...
	upDown := footerHintsForKeys(hints, "↑/↓")
	arrow := footerHintsForKeys(hints, "←/→")
	coreActions := footerHintsForKeys(hints, "D", "h", "enter", "s", "g", "m", "d")
	coreActionsWithoutSafety := footerHintsForKeys(hints, "h", "enter", "s", "g", "m", "d")
	coreActionsWithAuto := footerHintsForKeys(hints, "D", "h", "enter", "s", "g", "m", "d", "a")
	coreActionsWithAutoWithoutSafety := footerHintsForKeys(hints, "h", "enter", "s", "g", "m", "d", "a")
	selectedActionsWithAuto := footerHintsForKeys(hints, "D", "h", "enter", "s", "g", "m", "x", "o", "y", "d", "r", "a")
	actions := footerHintsForKeys(hints, "D", "n", "h", "enter", "s", "g", "m", "x", "o", "y", "d", "r", "a", "A", "M", "E", "f", "F")
	actionsWithoutEffort := footerHintsForKeys(hints, "D", "n", "h", "enter", "s", "g", "m", "x", "o", "y", "d", "r", "a", "A", "M", "f", "F")
	actionsWithoutModelAndEffort := footerHintsForKeys(hints, "D", "n", "h", "enter", "s", "g", "m", "x", "o", "y", "d", "r", "a", "A", "f", "F")
	actionsWithoutAgentAndPreferences := footerHintsForKeys(hints, "D", "n", "h", "enter", "s", "g", "m", "x", "o", "y", "d", "r", "a", "f", "F")
